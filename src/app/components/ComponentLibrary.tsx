    ...
    items: [
      {
        ...
        name: "Section",
        icon: Layout,
        defaultProps: { bgColor: "#ffffff", padding: "48", fullWidth: true },
      },
      {
        id: "container",
        name: "Container",
      ...
      },
      {
        ...
        name: "2 Columns",
        icon: Columns,
        defaultProps: { columns: 2, gap: "24", bgColor: "transparent" },
      },
      {
        id: "grid",
        name: "Grid",
        icon: Grid3x3,
        defaultProps: { columns: 3, gap: "16", bgColor: "transparent" },
      },
      {
        id: "spacer",
        name: "Spacer",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Icon",
        icon: Star,
        defaultProps: { iconType: "star", size: "32", color: "#2563eb" },
      },
      {
        id: "divider",
        name: "Divider",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Checkbox",
        icon: CheckSquare,
        defaultProps: { label: "I agree to terms and conditions" },
      },
      {
        id: "form",
        name: "Form",
        icon: Mail,
        defaultProps: { submitText: "Submit", action: "#" },
      },
    ],
  },
  {
            ...
            filteredCategories[activeCategory].items.map((component) => {
              ...
              return (
                <div
                  ...
                  draggable
                  onDragStart={(e) =>
                    onDragStart(component.id, component.defaultProps, e)
                  }
